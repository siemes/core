...
module.exports = () => (
  {
    adminSearch() {
      ...
      q.param('mediaType', null).option('mediaTypeParser', 'prop');
      q.parser('mediaTypeParser', (prop, value) => (
        { itemType: value }
      ));

      q.param('mime', null).option('mimeParser', 'prop');
      q.parser('mimeParser', (prop, value) => (
        { mime: new RegExp(value, 'i') }
      ));
